...
1. If you do not already have one, create a project in GitLab and copy the files from this repo into it. Make sure to include the hidden `.gitlab-ci.yml` and `.gitignore` files but not the `.git` folder.
